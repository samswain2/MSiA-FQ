...
Positive relationship: displacement, origin, year^2
Negative relationship: cylinders, weight, year
Origin and year are significantly different from 0
$R^2 = 0.8273$
...
The parameter estimates for x1 and x2 are 1.4396 and 1.0097. The two coefficients are both significantly different from 0
...
Yes, in 2c both confidence intervals are covering the true values. The betas are also both significant. However, in 2e we found that $\beta_2$ alone is not significant. This is weird because in one model it is and one model it isn't.
...
The value of R^2 in the first model is 0.0008724, the value of R^2 in the second model is 0.8587. According to R^2, the second model is better. But this may not be the right model because the vif suggests there are high multicollinearity.
